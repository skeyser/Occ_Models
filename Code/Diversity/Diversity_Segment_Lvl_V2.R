...
#Rarefaction, keeping code intact, likely won't be used
# spp.accum <- specaccum(bbs_cast[1:10,])
# plot(spp.accum)
# 
# #loop through 10 random sites
# rand_site <- sample(1:nrow(bbs_cast), 25, replace = FALSE )
# 
# par(mfrow = c(3,4))
# 
